...
####PalindromeLinkedList234_7

PalindromeLinkedList234_6 와 거의 동일한 방법으로 풀이하고 세부 구현은 조금 다르다.

런너 기법을 활용하는데 cur, rear 를 이동하면서 cur 를 뒤집는다.

그리고나서 front 와 cur 이 서로 이동하면서 값이 동일한지 판단한다.
